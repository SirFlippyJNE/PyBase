...
def run_snek_500():    
    ...
    current_score_text = font.render('Score', current_score, True, 'green')
    high_score_text = font.render('High Score', high_score, True, 'green')
    
    # create a rectangular object for the
    # text surface object
    CSTRect = current_score_text.get_rect()
    HST = high_score_text.get_rect()
    
    # set the center of the rectangular object.
    CSTRect.center = (WINDOW // 2, TILE_SIZE // 2)
    HST.center = (WINDOW // 2, TILE_SIZE // 12)
    #snek
    while True:
        screen.blit(current_score_text, CSTRect)
        screen.blit(high_score_text, HST)
